...
if __name__ == "__main__":
    ...
    # parent app/local/prep
    PATH_TO_ROOT_DIR = Path(__file__).parent.parent.parent.parent
    # PATH_TO_ROOT_DIR = Path(__file__).parent.parent.parent.parent.parent # later use constants from project
    PATH_TO_RAY_OUTPUT_DIR = PATH_TO_ROOT_DIR / "app" / "local" / "output"
