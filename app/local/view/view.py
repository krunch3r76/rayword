...
#--
from app.local.view.log_window_group import LogWindowGroup
from .mywindow import (
    TextEntryBox,
    MyWindowSelectable,
)
from .panel_manager import PanelManager
from app.local.view.color_pairs import init_color_pairs
from app.local.view.specialized import PauseWindow
...
class View:
    ...
    def __init__(self, to_controller: Queue, from_controller: Queue):
        try:
            ...
            self.pause_window = PauseWindow(self._stdscr)
