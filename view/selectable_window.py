...
#     ):
#         """
#         Initialize a panel line-buffered window with the given parameters.
#         """
#         super().__init__(stdscr, upper_left_y, upper_left_x, height, width, boxed)
#         self.panel = curses.panel.new_panel(self._win)

#     def top(self):
#         """
#         Bring this panel to the top of the stack.
#         """
#         self.panel.top()
...
class PanelManager:
    ...
    def add_panel(self, upper_left_y, upper_left_x, height, width, boxed=False):
        panel = MyWindowLineBufferedWrapped(
            self.stdscr, upper_left_y, upper_left_x, height, width, boxed
        )
